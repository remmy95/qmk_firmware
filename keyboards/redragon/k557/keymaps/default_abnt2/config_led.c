...
led_config_t g_led_config = { {
  ...
  {  93,     94,  95,  96,  97,  98,  99, NO_LED, 100, NO_LED, NO_LED, NO_LED, NO_LED, NO_LED,    101,    102,    103,  NO_LED,    104,    105, NO_LED }
    ...
    { 1 *12, 44 }, { 2 *12, 44 }, { 3 *12, 44 }, { 4 *12, 44 }, { 5 *12,  44 }, { 6 *12,  44 }, { 7 *12,  44 }, { 8 *12, 44 }, { 9 *12,  44 }, { 10*12, 44 }, { 11*12, 44 }, { 12*12, 44 }, { 13*12, 44 }, { 14*12, 44 },                { 16*12, 44 },                { 18*12, 44 }, { 19*12, 44 }, { 20*12, 44 }, { 21*12, 44 },
